...
const SectionE2: React.FC = () => {
	return (
		<div className='w-full bg-blue-50 py-16 px-4 sm:px-6 lg:px-8'>
			<div className='max-w-7xl mx-auto'>
				<h2 className='text-4xl sm:text-5xl font-bold text-gray-900 text-center'>
					Events & Conferences
				</h2>
				<p className='text-lg md:text-xl text-gray-600 text-center mt-4 mb-12'>
					Gatherings that ignite revival, equip believers, and glorify Jesus.
				</p>

				<div className='text-center text-gray-400 text-2xl mb-8'>⸻</div>
				...
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12 items-center'>
					<div>
						...
						<p className='text-orange-600 text-xl font-medium'>– May</p>
				...
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12 items-center'>
					<div>
						...
						<p className='text-orange-600 text-xl font-medium'>– January</p>
						<p className='text-lg text-gray-600 mt-4 leading-relaxed'>
